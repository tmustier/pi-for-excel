...
- **Coverage signaling:** non-checkpointed mutation tools (`format_cells`, `modify_structure`, and mutating `view_settings` actions) explicitly report when no recovery checkpoint was created.
