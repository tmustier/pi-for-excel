 ...
 * All are optional; unset means stock behavior.
 */
interface ImportMetaEnv {
  ...
  /** Set to "false" to preserve original image dimensions and encoded sizes. */
  readonly VITE_PI_AUTO_RESIZE_IMAGES?: string;
